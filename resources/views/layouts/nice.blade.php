...
<head>
    ...
    <title>Petshop Dashboards</title>
    <!-- Custom CSS -->
    <link href="{{ asset('assets/libs/chartist/dist/chartist.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/extra-libs/c3/c3.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/extra-libs/jvector/jquery-jvectormap-2.0.2.css') }}" rel="stylesheet" />
    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{ secure_asset('dashboard.css') }}">
...
<style>
    ...
    .logo{
        text-shadow:
            0 0 4px rgba(255,213,79,.7),
            0 0 10px rgba(255,213,79,.45),
            0 0 18px rgba(255,213,79,.25);
    }
                    ...
                    <ul class="navbar-nav float-right">
                                    ...
                                    <li>
                                        <div class="message-center message-body">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="../../assets/image/users/1.jpg" alt="user" class="rounded-circle">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="../../assets/image/users/2.jpg" alt="user" class="rounded-circle">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="../../assets/image/users/3.jpg" alt="user" class="rounded-circle">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="../../assets/image/users/4.jpg" alt="user" class="rounded-circle">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                {{-- <img src="../../assets/image/users/2.jpg" alt="user" class="rounded-circle" width="40"> --}}
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class="">
                                        <img src="../../assets/image/users/2.jpg" alt="user" class="rounded-circle" width="60">
                                    </div>
                                    @auth
                                    <div class="m-l-10">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ route('user.index') }}" class="sidebar-link">
                                        <i class="mdi mdi-view-quilt"></i>
                                        <span class="hide-menu">Master Users</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{{ route('animal.index') }}" class="sidebar-link">
                                        <i class="mdi mdi-view-parallel"></i>
                                        <span class="hide-menu">Master Animal</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                ...
                                <li class="sidebar-item">
                                    <a href="{{ route('karyawan.index') }}" class="sidebar-link">
                                        <i class="mdi mdi-view-parallel"></i>
                                        <span class="hide-menu">Master Karyawan</span>
                                    </a>
                                </li>
...
{{-- Next Menu --}}
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('home') }}" aria-expanded="false">
                                    <i class="mdi mdi-content-paste"></i>
                                    <span class="hide-menu">Beralih Ke Website</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button type="submit"
                                        class="sidebar-link waves-effect waves-dark sidebar-link border-0 bg-transparent w-full text-start">
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade p-15" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                    ...
                    <div class="steamline">
                        ...
                        <div class="sl-item">
                            <div class="sl-left">
                                <img class="rounded-circle" alt="user" src="../../assets/image/users/2.jpg"> </div>
                            <div class="sl-right">
                        ...
                        <div class="sl-item">
                            <div class="sl-left">
                                <img class="rounded-circle" alt="user" src="../../assets/image/users/1.jpg"> </div>
                            <div class="sl-right">
                                <div>
                        ...
                        <div class="sl-item">
                            <div class="sl-left">
                                <img class="rounded-circle" alt="user" src="../../assets/image/users/4.jpg"> </div>
                            <div class="sl-right">
                                <div class="font-medium">Go to the Doctor
                                    <span class="sl-date">5 minutes ago</span>
                                </div>
                        ...
                        <div class="sl-item">
                            <div class="sl-left">
                                <img class="rounded-circle" alt="user" src="../../assets/image/users/6.jpg"> </div>
                            <div class="sl-right">
                                <div>
                                    <a href="javascript:void(0)">Stephen</a>
                                    <span class="sl-date">5 minutes ago</span>
